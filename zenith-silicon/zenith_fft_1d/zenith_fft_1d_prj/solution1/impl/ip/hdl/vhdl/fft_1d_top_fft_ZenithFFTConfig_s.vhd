...
entity fft_1d_top_fft_ZenithFFTConfig_s is
    generic (
        INPUT_WIDTH  : integer := 32;
        OUTPUT_WIDTH : integer := 32;
        CONFIG_WIDTH : integer := 32;
        STATUS_WIDTH : integer := 32
    );
    port (
        ap_clk                         : in  std_logic;
        ap_rst                         : in  std_logic;
...
architecture arch of fft_1d_top_fft_ZenithFFTConfig_s is
attribute DowngradeIPIdentifiedWarnings : STRING;
attribute DowngradeIPIdentifiedWarnings of arch : architecture is "yes";
    --------------------- Component ---------------------
    component fft_1d_top_fft_ZenithFFTConfig_s_core_ip is
        port (
            aclk                        : in  std_logic;
            aclken                      : in  std_logic;
...
begin
    --------------------- Instantiation -----------------
    inst : component fft_1d_top_fft_ZenithFFTConfig_s_core_ip
    port map (
        aclk                        => ap_clk,
        aclken                      => ap_ce,
        aresetn                     => aresetn,
