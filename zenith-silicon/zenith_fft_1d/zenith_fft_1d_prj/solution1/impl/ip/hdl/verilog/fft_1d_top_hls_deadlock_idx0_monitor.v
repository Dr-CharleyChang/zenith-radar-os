...
module fft_1d_top_hls_deadlock_idx0_monitor ( // for module fft_1d_top_fft_1d_top_inst
    input wire clock,
    input wire reset,
...
assign process_axis_block_vec[3] = idx4_block & (1'b0 | axis_block_sigs[2]);
...
// instant sub module
 fft_1d_top_hls_deadlock_idx1_monitor fft_1d_top_hls_deadlock_idx1_monitor_U (
    .clock(clock),
    .reset(reset),
