...
`timescale 1ns/1ps
(* DowngradeIPIdentifiedWarnings="yes" *) module fft_1d_top_out_bufQ_RAM_2P_BRAM_1R1W
#(parameter
    DataWidth    = 1,
    AddressRange = 1024,
    AddressWidth = 10,
...
generate
    for (i = 0; i < BufferCount; i = i + 1) begin : gen_buffer
        fft_1d_top_out_bufQ_RAM_2P_BRAM_1R1W_memcore fft_1d_top_out_bufQ_RAM_2P_BRAM_1R1W_memcore_U (
            .ce0      ( buf_ce0[i] ),
            .address0 ( buf_a0[i] ),
            .q0       ( buf_q0[i] ),
            .ce1      ( buf_ce1[i] ),
