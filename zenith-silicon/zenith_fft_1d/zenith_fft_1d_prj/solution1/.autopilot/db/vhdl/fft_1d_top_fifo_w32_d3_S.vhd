...
entity fft_1d_top_fifo_w32_d3_S is 
    generic (
...
architecture rtl of fft_1d_top_fifo_w32_d3_S is
...
------------------------Component----------------------
    component fft_1d_top_fifo_w32_d3_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 32;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 3);
...
begin
----------------------- Instantiation -----------------------
    U_fft_1d_top_fifo_w32_d3_S_ShiftReg : fft_1d_top_fifo_w32_d3_S_ShiftReg
    generic map (
...
entity fft_1d_top_fifo_w32_d3_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 32;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 3);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end fft_1d_top_fifo_w32_d3_S_ShiftReg;

architecture rtl of fft_1d_top_fifo_w32_d3_S_ShiftReg is
