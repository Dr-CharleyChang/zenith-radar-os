...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename outI \
    op interface \
    ports { outI_address0 { O 10 vector } outI_ce0 { O 1 bit } outI_q0 { I 16 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename outQ \
    op interface \
    ports { outQ_address0 { O 10 vector } outQ_ce0 { O 1 bit } outQ_q0 { I 16 vector } } \
} "
} else {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler fft_1d_top_regslice_both BINDTYPE {interface} TYPE {adapter} IMPL {reg_slice}
}
