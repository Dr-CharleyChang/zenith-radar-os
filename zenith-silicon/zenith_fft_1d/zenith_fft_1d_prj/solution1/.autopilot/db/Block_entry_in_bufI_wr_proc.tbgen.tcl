set moduleName Block_entry_in_bufI_wr_proc
set isTopModule 0
...
set cdfgNum 12
set C_modelName {Block_entry_in_bufI_wr_proc}
...
set C_modelArgList {
	...
	{ in_bufI int 16 regular {array 1024 { 3 0 } 0 1 }  }
	{ in_bufQ int 16 regular {array 1024 { 3 0 } 0 1 }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "in_stream_V_data_V", "interface" : "axis", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "in_bufI", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
 	{ "Name" : "in_bufQ", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ in_bufI_address1 sc_out sc_lv 10 signal 7 } 
	{ in_bufI_ce1 sc_out sc_logic 1 signal 7 } 
	{ in_bufI_we1 sc_out sc_logic 1 signal 7 } 
	{ in_bufI_d1 sc_out sc_lv 16 signal 7 } 
	{ in_bufQ_address1 sc_out sc_lv 10 signal 8 } 
	{ in_bufQ_ce1 sc_out sc_logic 1 signal 8 } 
	{ in_bufQ_we1 sc_out sc_logic 1 signal 8 } 
	{ in_bufQ_d1 sc_out sc_lv 16 signal 8 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "in_bufI_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "in_bufI", "role": "address1" }} , 
 	{ "name": "in_bufI_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "in_bufI", "role": "ce1" }} , 
 	{ "name": "in_bufI_we1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "in_bufI", "role": "we1" }} , 
 	{ "name": "in_bufI_d1", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "in_bufI", "role": "d1" }} , 
 	{ "name": "in_bufQ_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "in_bufQ", "role": "address1" }} , 
 	{ "name": "in_bufQ_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "in_bufQ", "role": "ce1" }} , 
 	{ "name": "in_bufQ_we1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "in_bufQ", "role": "we1" }} , 
 	{ "name": "in_bufQ_d1", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "in_bufQ", "role": "d1" }}  ]}
...
set Spec2ImplPortList { 
	...
	in_bufI { ap_memory {  { in_bufI_address1 MemPortADDR2 1 10 }  { in_bufI_ce1 MemPortCE2 1 1 }  { in_bufI_we1 MemPortWE2 1 1 }  { in_bufI_d1 MemPortDIN2 1 16 } } }
	in_bufQ { ap_memory {  { in_bufQ_address1 MemPortADDR2 1 10 }  { in_bufQ_ce1 MemPortCE2 1 1 }  { in_bufQ_we1 MemPortWE2 1 1 }  { in_bufQ_d1 MemPortDIN2 1 16 } } }
}
