create_ip -vlnv xilinx.com:ip:xfft -module_name fft_1d_top_fft_ZenithFFTConfig_s_core_ip
set_property -dict [list \
    ...
    CONFIG.systolicfft_inv {0} \
    CONFIG.target_clock_frequency {150} \
    CONFIG.throttle_scheme {nonrealtime} \
    CONFIG.transform_length {1024} \
    CONFIG.xk_index {0} \
] -objects [get_ips fft_1d_top_fft_ZenithFFTConfig_s_core_ip]
set_property generate_synth_checkpoint false [get_files fft_1d_top_fft_ZenithFFTConfig_s_core_ip.xci]
generate_target {synthesis simulation} [get_files fft_1d_top_fft_ZenithFFTConfig_s_core_ip.xci]
