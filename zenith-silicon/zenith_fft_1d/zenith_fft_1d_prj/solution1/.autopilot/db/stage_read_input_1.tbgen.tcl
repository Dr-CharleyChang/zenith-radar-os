set moduleName stage_read_input_1
set isTopModule 0
...
set cdfgNum 12
set C_modelName {stage_read_input.1}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict bufI { MEM_WIDTH 16 MEM_SIZE 2048 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict bufQ { MEM_WIDTH 16 MEM_SIZE 2048 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	...
	{ bufI int 16 regular {array 1024 { 3 0 } 0 1 }  }
	{ bufQ int 16 regular {array 1024 { 3 0 } 0 1 }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "in_stream_V_data_V", "interface" : "axis", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "bufI", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
 	{ "Name" : "bufQ", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ bufI_address1 sc_out sc_lv 10 signal 7 } 
	{ bufI_ce1 sc_out sc_logic 1 signal 7 } 
	{ bufI_we1 sc_out sc_logic 1 signal 7 } 
	{ bufI_d1 sc_out sc_lv 16 signal 7 } 
	{ bufQ_address1 sc_out sc_lv 10 signal 8 } 
	{ bufQ_ce1 sc_out sc_logic 1 signal 8 } 
	{ bufQ_we1 sc_out sc_logic 1 signal 8 } 
	{ bufQ_d1 sc_out sc_lv 16 signal 8 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "bufI_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "bufI", "role": "address1" }} , 
 	{ "name": "bufI_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "bufI", "role": "ce1" }} , 
 	{ "name": "bufI_we1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "bufI", "role": "we1" }} , 
 	{ "name": "bufI_d1", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "bufI", "role": "d1" }} , 
 	{ "name": "bufQ_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "bufQ", "role": "address1" }} , 
 	{ "name": "bufQ_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "bufQ", "role": "ce1" }} , 
 	{ "name": "bufQ_we1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "bufQ", "role": "we1" }} , 
 	{ "name": "bufQ_d1", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "bufQ", "role": "d1" }}  ]}
...
set Spec2ImplPortList { 
	...
	bufI { ap_memory {  { bufI_address1 MemPortADDR2 1 10 }  { bufI_ce1 MemPortCE2 1 1 }  { bufI_we1 MemPortWE2 1 1 }  { bufI_d1 MemPortDIN2 1 16 } } }
	bufQ { ap_memory {  { bufQ_address1 MemPortADDR2 1 10 }  { bufQ_ce1 MemPortCE2 1 1 }  { bufQ_we1 MemPortWE2 1 1 }  { bufQ_d1 MemPortDIN2 1 16 } } }
}
