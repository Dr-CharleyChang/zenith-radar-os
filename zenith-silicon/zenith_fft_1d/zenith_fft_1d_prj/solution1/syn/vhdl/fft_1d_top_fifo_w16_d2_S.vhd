...
entity fft_1d_top_fifo_w16_d2_S is 
    generic (
...
architecture rtl of fft_1d_top_fifo_w16_d2_S is
...
------------------------Component----------------------
    component fft_1d_top_fifo_w16_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 16;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_fft_1d_top_fifo_w16_d2_S_ShiftReg : fft_1d_top_fifo_w16_d2_S_ShiftReg
    generic map (
...
entity fft_1d_top_fifo_w16_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 16;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end fft_1d_top_fifo_w16_d2_S_ShiftReg;

architecture rtl of fft_1d_top_fifo_w16_d2_S_ShiftReg is
