...
module fft_1d_top_stage_read_input_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
assign add_ln41_fu_140_p2 = (ap_sig_allocacmp_i_4 + 11'd1);
...
assign icmp_ln41_fu_134_p2 = ((ap_sig_allocacmp_i_4 == 11'd1024) ? 1'b1 : 1'b0);

assign trunc_ln73_fu_160_p1 = in_stream_TDATA[15:0];

assign zext_ln41_fu_151_p1 = i_4_reg_181;

endmodule //fft_1d_top_stage_read_input_1
